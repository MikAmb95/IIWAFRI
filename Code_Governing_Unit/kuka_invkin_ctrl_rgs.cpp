...
ofstream myfile_qd;
ofstream myfile_p;
myfile_qd.open("/home/utente/ros_ws/src/iiwa_kdl/src/rgs.m");
myfile_p.open("/home/utente/ros_ws/src/iiwa_kdl/src/prgs.m");
myfile_qd<<"q_rgs = [";
myfile_p<<"param_rgs = [";
...
int main(int argc, char** argv) {
        int x;
        cout<<"RGS CONTROL PRESS 1 TO START"<<endl;
        cin>>x;        
	ros::init(argc, argv, "iiwa_kdl_rgs");
	KUKA_INVKIN ik;
	ik.run();
